...
# don't run anuthing past here while we troubleshoot
#streamlit.stop()
...
#Add a button to load th fruit
streamlit.header("View Our Fruit List - Add yout Favorites!")
